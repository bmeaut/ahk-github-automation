...
public class ConfigYamlParserTest
{
    ...
    [DataRow("enabled: true\r\naaa: 1")]
    [DataRow("aaa: 1\r\nenabled: true")]
    public void ConfigYamlIsEnabled(string value) => Assert.IsTrue(ConfigYamlParser.IsEnabled(value));
    ...
    public void ConfigYamlIsDisabled(string value) => Assert.IsFalse(ConfigYamlParser.IsEnabled(value));
}
