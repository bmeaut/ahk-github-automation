...
namespace Ahk.Web.Data.Migrations
{
    ...
    [Migration("20260902225915_SubmissionArchive")]
    partial class SubmissionArchive
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Ahk.Web.Data.Entities.ApplicationUser", b =>
                {
                    ...
                    b.Property<DateTimeOffset?>("GitHubVerifiedAt")
            ...
            modelBuilder.Entity("Ahk.Web.Data.Entities.GitHubWebhookDelivery", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("FailedHandlerCount")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("CourseId", "ReceivedAt");
            ...
            modelBuilder.Entity("Ahk.Web.Data.Entities.PersonalAccessToken", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
