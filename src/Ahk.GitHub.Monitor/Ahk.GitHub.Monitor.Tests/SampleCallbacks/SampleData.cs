...
{
    public static readonly SampleCallbackData BranchCreate = new(getTextFromResource("branch_create.json"),
        "sha256=42197ad6cad74be8674363735038df64ca2ae8e8bdf027da60164adfbc561f4b", "create");
    ...
    private static string getTextFromResource(string resourceName)
    {
        using Stream s = Assembly.GetExecutingAssembly()
            .GetManifestResourceStream($"Ahk.GitHub.Monitor.Tests.SampleCallbacks.{resourceName}");
