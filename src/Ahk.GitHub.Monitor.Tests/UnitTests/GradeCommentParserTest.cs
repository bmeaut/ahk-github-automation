...
namespace Ahk.GitHub.Monitor.Tests.UnitTests
{
    ...
    public class GradeCommentParserTest
    {
        ...
        [DataRow("@ahk ok 1.33, 2.5, 44\r\n\r\nsomething")]
        [DataRow("@ahk ok 1.33;2.5;44\r\n\r\nsomething")]
        public void IsGradeComment(string value)
        {
            Assert.IsTrue(new GradeCommentParser(value).IsMatch);
        }
        ...
        [DataRow("@ahkok\r\n\r\nsomething")]
        [DataRow("@ahk okk\r\n\r\nsomething")]
        public void IsNotGradeComment(string value)
        {
            Assert.IsFalse(new GradeCommentParser(value).IsMatch);
        }
        ...
        {
            var actualGrades = new GradeCommentParser(value).Grades;
            CollectionAssert.AreEqual(expectedGrades, actualGrades.ToList());
        }
    }
}
