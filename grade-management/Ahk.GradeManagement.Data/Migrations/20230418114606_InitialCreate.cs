    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BranchCreateEvents", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RepositoryCreateEvents", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Neptun = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    EduEmail = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    GithubUser = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GithubOrg = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ahkConfig = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    PullRequestEventId = table.Column<int>(type: "int", nullable: false),
                    GithubUser = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Assignee_PullRequestEvents_PullRequestEventId",
                        column: x => x.PullRequestEventId,
                        principalTable: "PullRequestEvents",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ClassroomAssignment = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    GithubRepoName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    GithubPrNumber = table.Column<int>(type: "int", nullable: false),
                    GithubPrUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Assignee_PullRequestEventId",
                table: "Assignee",
                column: "PullRequestEventId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Exercises_AssignmentId",
                table: "Exercises",
                column: "AssignmentId");
